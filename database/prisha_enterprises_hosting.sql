-- Prisha Enterprises - Hostomy / shared hosting import
-- Select your ioPanel database in phpMyAdmin first, then Import this file.
-- Do not use CREATE DATABASE (not allowed on shared hosting).
